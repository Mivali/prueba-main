...
export default function AddTodo(){
    ...
    const addTodo = async () => {
        ...
        try{
            await AsyncStorage.setItem('Tareas', JSON.stringify([... listTodos, newTask])); //guardamos lo que estaba en el estado de redux MAS el nuevo to do. Lo convertimos a JSON
